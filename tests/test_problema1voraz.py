...
from problema1voraz import subsecuencia_palindromica_voraz  # Importar la función Voraz
from problema1 import normalizar_cadena  # Importar la función de normalización
...
class TestVoraz(unittest.TestCase):
    ...
    def test_palindromos_voraz(self):
        ...
        tamaños = {
            ...
            "Extra grande": [generar_cadena_aleatoria(1000) for _ in range(1000)],  # Cadenas de gran tamaño
        }
        ...
        for nombre, entradas in tamaños.items():
            ...
            for _ in range(5):  # Ejecutar cada prueba 5 veces para obtener valores promedio
                ...
                for entrada in entradas:
                    ...
                    # Medir el tiempo de ejecución del algoritmo Voraz
                    inicio = time.time()
                    ...
                    if nombre == "Juguete":
                        ...
                        print(f"   🟢 Voraz (Manacher): \"{resultado[0]}\" ({tiempo:.6f} segundos) ✅ Correcto")
            ...
            if nombre != "Juguete":
                print(f"   🟢 Voraz (Manacher) - Tiempo promedio en {nombre}: {sum(tiempos_totales) / 5:.6f} segundos")
